...
public class Verify_2_Release_shr_C_B {
...
//               		       	 	 driver.findElement(By.xpath("//input[@name ='rtaIntRefNo']")).clear();
               ...
               WebDriverWait wait111 = new WebDriverWait(driver ,Duration.ofMillis(20));
   	 	    ...
   	 	    WebElement element111 = wait111.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id ='CorporateActionHeaderSearchId1']")));
   	 	   element111.click();
   	 	 Thread.sleep(1000);
